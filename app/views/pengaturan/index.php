    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm" x-data="logoUpload()">
        ...
        <form action="<?= BASEURL; ?>/pengaturan/update" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Teks Logo Sidebar (Jika Gambar Kosong)</label>
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-1">Disarankan rasio 1:1, format PNG/JPG transparan.</p>
                </div>
            </div>
