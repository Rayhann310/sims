            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <p class="text-slate-400 leading-relaxed mb-6 max-w-md">
                        Mencetak generasi penerus bangsa yang unggul dalam IPTEK, berlandaskan IMTAQ, serta berwawasan lingkungan global.
                    </p>
                ...
                <!-- Tautan Cepat -->
                <div>
                    <h3 class="text-white font-semibold mb-6">Tautan Cepat</h3>
                    <ul class="space-y-3">
                        <li><a href="#" class="hover:text-white hover:underline transition-all">Profil Sekolah</a></li>
                        <li><a href="#" class="hover:text-white hover:underline transition-all">Pendaftaran (PPDB)</a></li>
                        <li><a href="#" class="hover:text-white hover:underline transition-all">Kurikulum</a></li>
                        <li><a href="#" class="hover:text-white hover:underline transition-all">Prestasi</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm">Jakarta</span>
                        </li>
                        <li class="flex items-center gap-3">
                            ...
                            <span class="text-sm">(021) 555-0123</span>
                        </li>
                        <li class="flex items-center gap-3">
