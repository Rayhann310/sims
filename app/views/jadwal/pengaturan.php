    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                ...
                <form action="<?= BASEURL; ?>/jadwal/simpanIstirahat" method="POST" class="mb-4">
                    <div class="space-y-3">
                        <input type="text" name="nama_istirahat" placeholder="Nama (cth: Istirahat 1, Upacara)" class="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-sm" required>
                        <div class="flex gap-2">
                            <input type="number" name="setelah_jp_ke" placeholder="Stlh JP ke" class="w-1/2 px-3 py-2 border border-slate-200 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-sm" required>
                            <input type="number" name="durasi_menit" placeholder="Durasi (m)" class="w-1/2 px-3 py-2 border border-slate-200 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-sm" required>
                        </div>
                        <input type="text" name="hari_khusus" placeholder="Khusus Hari (kosongkan = tiap hari)" class="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-sm">
                        <button type="submit" class="w-full bg-slate-800 text-white font-medium py-2 rounded-lg hover:bg-slate-900 transition-colors text-sm">Tambah Istirahat</button>
                    </div>
                </form>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 h-full">
                ...
                <form action="<?= BASEURL; ?>/jadwal/simpanAlokasi" method="POST" class="mb-6 flex gap-3 flex-wrap items-end bg-slate-50 p-4 rounded-xl border border-slate-100">
                    <div class="flex-1 min-w-[200px]">
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Mata Pelajaran</label>
                        <select name="mapel_id" class="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-sm" required>
                    ...
                    <div class="w-24">
                        ...
                        <select name="tingkat" class="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-sm" required>
                    ...
                    <div class="w-32">
                        ...
                        <select name="jurusan" class="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-sm" required>
                    ...
                    <div class="w-24">
                        ...
                        <input type="number" name="jumlah_jp" value="2" class="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-sm" required>
                    </div>
                    ...
                    <table class="w-full text-left text-sm text-slate-600">
                        <thead class="bg-slate-50 text-slate-700 font-bold border-b border-slate-200 uppercase text-xs">
                            <tr>
                                ...
                                <th class="py-3 px-4 rounded-tr-lg">Jml JP / Minggu</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-slate-100">
                            <?php foreach($data['alokasi'] as $a): ?>
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td class="py-3 px-4"><span class="font-bold text-emerald-600"><?= $a['jumlah_jp'] ?> JP</span></td>
                                </tr>
                            <?php endforeach; ?>
