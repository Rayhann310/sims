    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2 mt-4 sm:mt-0">
            ...
            <button onclick="document.getElementById('tambahModal').classList.remove('hidden')" class="btn bg-primary hover:bg-indigo-600 text-white flex items-center px-3 py-2 shadow-sm rounded-lg transition-colors">
                ...
                <span class="ml-2 font-medium text-sm">Upload File Disini</span>
            </button>
        </div>
    </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="w-full bg-slate-100 text-slate-500 rounded-lg px-4 py-2 text-sm border border-slate-200 cursor-not-allowed" value="<?= htmlspecialchars($data['kategori_aktif']['nama_kategori']); ?>" disabled>
                                    </div>
                                </div>
